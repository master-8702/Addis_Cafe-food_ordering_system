...
public class dinner extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnokdinner=findViewById(R.id.btnokdinner);
        btnokdinner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dinner.this,home_page.class);
